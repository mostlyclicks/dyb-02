...
Refinery::Pages.configure do |config|
  ...
  config.add_whitelist_elements = ["source", "track", "script", "noscript", "iframe"]
  ...
  config.add_whitelist_attributes = ["kind", "srclang", "placeholder", "controls", "required", "async", "defer"]
end
